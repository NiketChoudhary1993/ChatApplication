...
import com.example.niket.chatapplication.databinding.ActivityLoginGoogleBinding;
...
public class Login_Google extends AppCompatActivity {
    ...
    ActivityLoginGoogleBinding activityLoginBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityLoginBinding = DataBindingUtil.setContentView(this, R.layout.activity_login__google);
        ...
        if (sharedPreferences.getBoolean("status", false)) {
            ...
            Intent intent = new Intent(Login_Google.this, ChatPage.class);
        ...
        activityLoginBinding.googleSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                googleSignInClient = GoogleSignIn.getClient(Login_Google.this, googleSignInOptions);
        ...
        activityLoginBinding.Register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Login_Google.this, Register.class);
                startActivity(intent);
            }
        });
        ...
        activityLoginBinding.login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!TextUtils.isEmpty(activityLoginBinding.email.getText().toString()) || !TextUtils.isEmpty(activityLoginBinding.editTextPassword.getText().toString())) {
    ...
    private void loginUser(final View view) {
            ...
            firebaseAuth.signInWithEmailAndPassword(activityLoginBinding.email.getText().toString(), activityLoginBinding.editTextPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                @Override
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot data : dataSnapshot.getChildren()) {
                                    ...
                                    if (activityLoginBinding.email.getText().toString().equals(myPojo.getMobile())
                                ...
                                if (userFound == true) {
                                    ...
                                    dialog.cancel();
                                    Toast.makeText(Login_Google.this, "invalid Credentials", Toast.LENGTH_SHORT).show();
                                }
                            ...
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(Login_Google.this, "Database error", Toast.LENGTH_SHORT).show();
                            }
                        });
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> task, MyPojo myPojo1, DatabaseReference databaseReference_google) {
        ...
        try {
            ...
            Toast.makeText(Login_Google.this, "signInResult:failed code=" + e.getStatusCode(), Toast.LENGTH_SHORT).show();
    ...
    private void firebaseAuthWithGoogle(final GoogleSignInAccount account,final MyPojo myPojo1, final DatabaseReference databaseReference_google) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(Login_Google.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if(user.getDisplayName().equals(myPojo1.getName())){
                        ...
                        Toast.makeText(Login_Google.this, "user already register ...plz signIn ", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Login_Google.this, "Authentication failed", Toast.LENGTH_SHORT).show();
